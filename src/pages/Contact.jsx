...
import { Button, Footer, Label, TextInput, Select, Checkbox } from 'flowbite-react';
import axios from 'axios';
import { HiOutlineLocationMarker, HiOutlinePhone, HiMail } from 'react-icons/hi';
...
function Contact() {
  ...
  return (
    <div className="flex flex-col md:flex-row relative">
      <div className="mt-10">
        <a href="https://wa.me/message/H6GTSW5G5WWTK1" target="_blank" rel="noopener noreferrer">
